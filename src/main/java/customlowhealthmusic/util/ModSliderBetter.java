...
public class ModSliderBetter implements IUIElement {
    private static final float L_X;
    private static final float SLIDE_W;
    private final Consumer<ModSliderBetter> change;
    ...
    public ModSliderBetter(String lbl, float posX, float posY, float min, float max, float val, String format, ModPanel p, Consumer<ModSliderBetter> changeAction) {
        this.label = lbl;
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderFontRightAligned(sb, FontHelper.tipBodyFont, this.label, this.sliderX - 20.0F * Settings.scale, this.y, Color.WHITE);
